...
if __name__ == "__main__":
    ...
    problem_name = 'Rwall'
    all_params["problem"] = Rwall.init_params(domain_range, viscosity, loss_weights, path_s, frequency, problem_name)
    all_params = Rwall.constraints(all_params)
    datas = Rwall.exact_solution(all_params)
